...
.method public static getInstance()Lmiui/security/Tida;
    ...
    .prologue
    .line 17
    const-string/jumbo v1, "miui.security.keystore"
...
.method public generateKeyPair(Ljava/lang/String;Ljava/lang/String;)Ljava/security/KeyPair;
    ...
    .end local v2    # "ret":Ljava/security/KeyPair;
    :cond_0
    :goto_0
    return-object v2

    .line 38
    .restart local v2    # "ret":Ljava/security/KeyPair;
    :catch_0
    move-exception v0
...
.method public getFpIds()Ljava/lang/String;
    ...
    .line 74
    .local v1, "fpIds":Ljava/lang/String;
    :try_start_0
    iget-object v2, p0, Lmiui/security/Tida;->mService:Lmiui/security/ITidaService;

    invoke-interface {v2}, Lmiui/security/ITidaService;->getFpIds()Ljava/lang/String;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 78
    .end local v1    # "fpIds":Ljava/lang/String;
    :goto_0
    return-object v1

    .line 75
    .restart local v1    # "fpIds":Ljava/lang/String;
    :catch_0
    move-exception v0
