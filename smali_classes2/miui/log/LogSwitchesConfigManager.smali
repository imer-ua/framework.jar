...
.method private buildLogSwitches([Ljava/lang/String;[Ljava/lang/String;Z)Ljava/util/HashMap;
    ...
    .line 196
    .local v2, "logSwitches":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/String;Lmiui/log/LogSwitch;>;"
    array-length v6, p1
    ...
    .line 202
    .restart local v1    # "logSwitch":Lmiui/log/LogSwitch;
...
.method private merge(Ljava/util/HashMap;Ljava/util/HashMap;)Ljava/util/HashMap;
    ...
    .line 151
    .local v5, "newConfig":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/String;Lmiui/log/AppLogSwitches;>;"
    ...
    .local v3, "currentAppLogSwitches$iterator":Ljava/util/Iterator;
    :cond_0
    :goto_0
    ...
    .line 152
    .local v2, "currentAppLogSwitches":Lmiui/log/AppLogSwitches;
    ...
    .line 154
    .local v4, "newAppLogSwitches":Lmiui/log/AppLogSwitches;
    if-nez v0, :cond_1
    ...
    .end local v2    # "currentAppLogSwitches":Lmiui/log/AppLogSwitches;
    .end local v4    # "newAppLogSwitches":Lmiui/log/AppLogSwitches;
    :cond_2
    ...
    .local v1, "appUpdates$iterator":Ljava/util/Iterator;
    :cond_3
    :goto_1
...
.method private merge(Ljava/util/HashMap;Lmiui/log/AppLogSwitches;)Ljava/util/HashMap;
    ...
    .local v1, "currentAppConfig$iterator":Ljava/util/Iterator;
    :cond_0
    :goto_0
    invoke-interface {v1}, Ljava/util/Iterator;->hasNext()Z
...
.method private revertLogSwitches(Landroid/content/Intent;)V
    ...
    .line 87
    .local v2, "currentConfig":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/String;Lmiui/log/AppLogSwitches;>;"
    new-instance v3, Ljava/util/HashMap;
...
.method private update(Lmiui/log/AppLogSwitches;Lmiui/log/AppLogSwitches;)V
    ...
    .local v2, "updateSwitch$iterator":Ljava/util/Iterator;
    :cond_0
    :goto_0
    ...
    .line 173
    .local v1, "updateSwitch":Lmiui/log/LogSwitch;
    ...
    .end local v1    # "updateSwitch":Lmiui/log/LogSwitch;
    :cond_2
    return-void
.end method
