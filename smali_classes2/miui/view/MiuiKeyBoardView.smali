...
.method private onKeyBoardDelete()V
    ...
    .line 235
    .local v0, "listener":Lmiui/view/MiuiKeyBoardView$OnKeyboardActionListener;
    invoke-interface {v0}, Lmiui/view/MiuiKeyBoardView$OnKeyboardActionListener;->onKeyBoardDelete()V

    goto :goto_0

    .line 233
    .end local v0    # "listener":Lmiui/view/MiuiKeyBoardView$OnKeyboardActionListener;
    :cond_0
    return-void
.end method
...
.method private shiftLetterBoard()V
    ...
    .line 424
    .local v0, "key":Lmiui/view/MiuiKeyBoardView$KeyButton;
    ...
    .line 431
    .end local v0    # "key":Lmiui/view/MiuiKeyBoardView$KeyButton;
...
.method public addKeyboardListener(Lmiui/view/MiuiKeyBoardView$OnKeyboardActionListener;)V
    ...
    .local v1, "actionListener$iterator":Ljava/util/Iterator;
    :cond_0
    invoke-interface {v1}, Ljava/util/Iterator;->hasNext()Z
...
.method protected onFinishInflate()V
    ...
    iput v1, p0, Landroid/view/View;->mPaddingTop:I
    ...
    iput v1, p0, Landroid/view/View;->mPaddingLeft:I
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual {v0, v8, v9, v2, v1}, Landroid/view/ViewGroup;->layout(IIII)V
