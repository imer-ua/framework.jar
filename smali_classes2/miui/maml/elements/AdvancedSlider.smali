...
.method private checkEndPoint(Lmiui/maml/util/Utils$Point;Lmiui/maml/elements/AdvancedSlider$EndPoint;)Z
    ...
    invoke-virtual {p2, v3, v4, v5}, Lmiui/maml/elements/AnimatedScreenElement;->touched(FFZ)Z
    ...
    .line 1148
    invoke-virtual {p2}, Lmiui/maml/elements/AdvancedSlider$SliderPoint;->getState()Lmiui/maml/elements/AdvancedSlider$State;
    ...
    invoke-virtual {p2, v3}, Lmiui/maml/elements/AdvancedSlider$SliderPoint;->setState(Lmiui/maml/elements/AdvancedSlider$State;)V
    ...
    .local v1, "ep$iterator":Ljava/util/Iterator;
    :cond_0
    :goto_0
    ...
    invoke-virtual {v0, v3}, Lmiui/maml/elements/AdvancedSlider$SliderPoint;->setState(Lmiui/maml/elements/AdvancedSlider$State;)V
    ...
    :cond_1
    iget-object v3, p2, Lmiui/maml/elements/AdvancedSlider$SliderPoint;->mName:Ljava/lang/String;

    invoke-virtual {p0, v3}, Lmiui/maml/elements/AdvancedSlider;->onReach(Ljava/lang/String;)V

    .line 1156
    .end local v1    # "ep$iterator":Ljava/util/Iterator;
    :cond_2
    const/4 v2, 0x1
...
.method private checkTouch(FF)Lmiui/maml/elements/AdvancedSlider$CheckTouchResult;
    ...
    .end local v4    # "point":Lmiui/maml/util/Utils$Point;
    .local v2, "ep$iterator":Ljava/util/Iterator;
    :cond_0
    :goto_0
    ...
    :goto_2
    invoke-virtual {v9, v8}, Lmiui/maml/elements/AdvancedSlider$SliderPoint;->setState(Lmiui/maml/elements/AdvancedSlider$State;)V

    .line 1122
    iget-boolean v8, p0, Lmiui/maml/elements/ScreenElement;->mHasName:Z
    ...
    invoke-virtual {v8, v9}, Lmiui/maml/elements/ScreenElement;->performAction(Ljava/lang/String;)V
...
.method private doLaunch(Lmiui/maml/elements/AdvancedSlider$EndPoint;)Z
    ...
    invoke-virtual {p1, v1}, Lmiui/maml/elements/ScreenElement;->performAction(Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v1, p1, Lmiui/maml/elements/AdvancedSlider$SliderPoint;->mName:Ljava/lang/String;
...
.method public onTouch(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v7, p0, Lmiui/maml/elements/AnimatedScreenElement;->mInterceptTouch:Z
    ...
    invoke-virtual {v9, v5, v6, v8}, Lmiui/maml/elements/AnimatedScreenElement;->touched(FFZ)Z
    ...
    invoke-virtual {v9, v10}, Lmiui/maml/elements/AdvancedSlider$SliderPoint;->setState(Lmiui/maml/elements/AdvancedSlider$State;)V
    ...
    invoke-virtual {v0, v9}, Lmiui/maml/elements/AdvancedSlider$SliderPoint;->setState(Lmiui/maml/elements/AdvancedSlider$State;)V
    ...
    .line 1006
    iget-boolean v9, p0, Lmiui/maml/elements/ScreenElement;->mHasName:Z
    ...
    .line 1037
    .restart local v2    # "keepStatus":Z
    :cond_a
    iget-object v9, p0, Lmiui/maml/elements/AdvancedSlider;->mStartPoint:Lmiui/maml/elements/AdvancedSlider$StartPoint;

    const-string/jumbo v10, "release"

    invoke-virtual {v9, v10}, Lmiui/maml/elements/ScreenElement;->performAction(Ljava/lang/String;)V
...
.method protected resetInner()V
    ...
    invoke-virtual {v2, v3}, Lmiui/maml/elements/AdvancedSlider$SliderPoint;->setState(Lmiui/maml/elements/AdvancedSlider$State;)V
    ...
    invoke-virtual {v0, v2}, Lmiui/maml/elements/AdvancedSlider$SliderPoint;->setState(Lmiui/maml/elements/AdvancedSlider$State;)V
