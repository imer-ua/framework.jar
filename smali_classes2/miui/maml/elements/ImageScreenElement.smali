...
.method private load(Lorg/w3c/dom/Element;)V
    ...
    .line 176
    iput-boolean v11, p0, Lmiui/maml/elements/ImageScreenElement;->mHasSrcRect:Z
    ...
    .line 180
    iput-boolean v11, p0, Lmiui/maml/elements/ImageScreenElement;->mHasWidthAndHeight:Z

    .line 183
    :cond_2
    const-string/jumbo v1, "blur"

    invoke-virtual {p0, p1, v1, v10}, Lmiui/maml/elements/ScreenElement;->getAttrAsInt(Lorg/w3c/dom/Element;Ljava/lang/String;I)I
    ...
    invoke-direct {v1, v2, v0, v11}, Lmiui/maml/data/IndexedVariable;-><init>(Ljava/lang/String;Lmiui/maml/data/Variables;Z)V
...
.method private renderWithMask(Landroid/graphics/Canvas;Lmiui/maml/elements/ImageScreenElement$Mask;II)V
    ...
    .prologue
    .line 488
    invoke-virtual/range {p0 .. p0}, Lmiui/maml/elements/ScreenElement;->getContext()Lmiui/maml/ScreenContext;

    move-result-object v3

    iget-object v3, v3, Lmiui/maml/ScreenContext;->mResourceManager:Lmiui/maml/ResourceManager;

    invoke-virtual/range {p2 .. p2}, Lmiui/maml/elements/ImageScreenElement;->getSrc()Ljava/lang/String;
    ...
    .line 493
    invoke-virtual/range {p2 .. p2}, Lmiui/maml/elements/ImageScreenElement;->getX()F
    ...
    .line 494
    .local v34, "maskX":D
    invoke-virtual/range {p2 .. p2}, Lmiui/maml/elements/ImageScreenElement;->getY()F
    ...
    .line 495
    .local v36, "maskY":D
    invoke-virtual/range {p2 .. p2}, Lmiui/maml/elements/AnimatedScreenElement;->getRotation()F
    ...
    :cond_1
    invoke-virtual/range {p2 .. p2}, Lmiui/maml/elements/AnimatedScreenElement;->getPivotX()F
    ...
    invoke-virtual/range {p2 .. p2}, Lmiui/maml/elements/AnimatedScreenElement;->getPivotY()F
    ...
    .line 533
    .local v38, "my":I
    invoke-virtual/range {p2 .. p2}, Lmiui/maml/elements/ImageScreenElement;->getWidth()F
    ...
    .line 536
    :cond_2
    invoke-virtual/range {p2 .. p2}, Lmiui/maml/elements/ImageScreenElement;->getHeight()F
    ...
    invoke-virtual/range {p2 .. p2}, Lmiui/maml/elements/AnimatedScreenElement;->getAlpha()I
    ...
    invoke-virtual {v0, v4, v5}, Lmiui/maml/elements/ScreenElement;->descale(D)D
    ...
    invoke-virtual {v0, v4, v5}, Lmiui/maml/elements/ScreenElement;->scale(D)F
...
.method protected doRender(Landroid/graphics/Canvas;)V
    ...
    .end local v16    # "aniHeight":F
    .end local v17    # "aniWidth":F
    .end local v20    # "height":F
    .end local v26    # "oldDensity":I
    ...
    .restart local v16    # "aniHeight":F
    .restart local v17    # "aniWidth":F
    .restart local v20    # "height":F
    .restart local v26    # "oldDensity":I
    ...
    invoke-virtual {v0, v6, v1}, Lmiui/maml/elements/ScreenElement;->getLeft(FF)F
    ...
    invoke-virtual {v0, v6, v1}, Lmiui/maml/elements/ScreenElement;->getTop(FF)F
    ...
    .line 409
    :cond_e
    invoke-virtual/range {p0 .. p0}, Lmiui/maml/elements/AnimatedScreenElement;->getMaxWidth()F

    move-result v24

    .line 410
    .local v24, "maxWidth":F
    invoke-virtual/range {p0 .. p0}, Lmiui/maml/elements/AnimatedScreenElement;->getMaxHeight()F
    ...
    .local v22, "mask$iterator":Ljava/util/Iterator;
    :goto_3
    ...
    .end local v22    # "mask$iterator":Ljava/util/Iterator;
    :cond_11
    move-object/from16 v0, p0
    ...
    .line 429
    .restart local v22    # "mask$iterator":Ljava/util/Iterator;
    :cond_12
    invoke-virtual/range {p1 .. p1}, Landroid/graphics/Canvas;->restore()V
...
.method protected doTick(J)V
    ...
    .local v1, "mask$iterator":Ljava/util/Iterator;
    :goto_0
    ...
    invoke-virtual {v0, p1, p2}, Lmiui/maml/elements/ImageScreenElement;->doTick(J)V

    goto :goto_0

    .line 559
    .end local v0    # "mask":Lmiui/maml/elements/ImageScreenElement$Mask;
    .end local v1    # "mask$iterator":Ljava/util/Iterator;
    :cond_2
    ...
    invoke-virtual {p0, v3}, Lmiui/maml/elements/ScreenElement;->evaluate(Lmiui/maml/data/Expression;)D

    move-result-wide v4

    invoke-virtual {p0, v4, v5}, Lmiui/maml/elements/ScreenElement;->scale(D)F
...
.method public finish()V
    ...
    .line 589
    .local v0, "mask":Lmiui/maml/elements/ImageScreenElement$Mask;
    invoke-virtual {v0}, Lmiui/maml/elements/ImageScreenElement;->finish()V
...
.method public init()V
    ...
    .line 268
    .local v0, "mask":Lmiui/maml/elements/ImageScreenElement$Mask;
    invoke-virtual {v0}, Lmiui/maml/elements/ImageScreenElement;->init()V
...
.method protected loadMesh(Lorg/w3c/dom/Element;)V
    ...
    invoke-virtual {p0, p1, v5}, Lmiui/maml/elements/ScreenElement;->getAttr(Lorg/w3c/dom/Element;Ljava/lang/String;)Ljava/lang/String;
...
.method public pause()V
    ...
    .line 603
    .local v0, "mask":Lmiui/maml/elements/ImageScreenElement$Mask;
    invoke-virtual {v0}, Lmiui/maml/elements/ImageScreenElement;->pause()V
...
.method protected pauseAnim(J)V
    ...
    .line 667
    .local v0, "mask":Lmiui/maml/elements/ImageScreenElement$Mask;
    invoke-virtual {v0, p1, p2}, Lmiui/maml/elements/ImageScreenElement;->pauseAnim(J)V
...
.method protected playAnim(JJJZZ)V
    ...
    .local v0, "mask$iterator":Ljava/util/Iterator;
    :goto_0
    ...
    .line 654
    invoke-virtual/range {v1 .. v9}, Lmiui/maml/elements/ImageScreenElement;->playAnim(JJJZZ)V

    goto :goto_0

    .line 657
    .end local v0    # "mask$iterator":Ljava/util/Iterator;
...
.method public reset(J)V
    ...
    .line 624
    .local v0, "mask":Lmiui/maml/elements/ImageScreenElement$Mask;
    invoke-virtual {v0, p1, p2}, Lmiui/maml/elements/ImageScreenElement;->reset(J)V
...
.method public resume()V
    ...
    .line 614
    .local v0, "mask":Lmiui/maml/elements/ImageScreenElement$Mask;
    invoke-virtual {v0}, Lmiui/maml/elements/ImageScreenElement;->resume()V
...
.method protected resumeAnim(J)V
    ...
    .line 677
    .local v0, "mask":Lmiui/maml/elements/ImageScreenElement$Mask;
    invoke-virtual {v0, p1, p2}, Lmiui/maml/elements/ImageScreenElement;->resumeAnim(J)V
