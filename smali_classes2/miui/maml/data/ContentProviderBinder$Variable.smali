...
.method public getImageElement(Lmiui/maml/ScreenElementRoot;)Lmiui/maml/elements/ImageScreenElement;
    ...
    .line 195
    :cond_1
    iget-object v0, p0, Lmiui/maml/data/VariableBinder$TypedValue;->mName:Ljava/lang/String;
...
.method protected parseType(Ljava/lang/String;)I
    ...
    iget-object v2, p0, Lmiui/maml/data/VariableBinder$TypedValue;->mTypeStr:Ljava/lang/String;
...
.method public setNull(Lmiui/maml/ScreenElementRoot;)V
    ...
    .line 189
    :cond_0
    invoke-virtual {p0, v1}, Lmiui/maml/data/VariableBinder$Variable;->set(Ljava/lang/Object;)V
