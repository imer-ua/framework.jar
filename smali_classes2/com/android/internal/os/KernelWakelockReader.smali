...
.method public final readKernelWakelockStats(Lcom/android/internal/os/KernelWakelockStats;)Lcom/android/internal/os/KernelWakelockStats;
    ...
    const-string/jumbo v9, "/proc/wakelocks"
    ...
    invoke-virtual {v6, v0, v7, v9}, Ljava/io/FileInputStream;->read([BII)I
    :try_end_1
    ...
    const-string/jumbo v9, "/d/wakeup_sources"
    ...
    .restart local v8    # "wakeup_sources":Z
    goto :goto_0
    ...
    :try_start_3
    const-string/jumbo v9, "KernelWakelockReader"

    const-string/jumbo v10, "neither /proc/wakelocks nor /d/wakeup_sources exists"
    ...
    const-string/jumbo v11, "Kernel wake locks exceeded buffer size "
    ...
    .end local v5    # "i":I
    :cond_2
    invoke-virtual {p0, v0, v7, v8, p1}, Lcom/android/internal/os/KernelWakelockReader;->parseProcWakelocks([BIZLcom/android/internal/os/KernelWakelockStats;)Lcom/android/internal/os/KernelWakelockStats;
    ...
    const-string/jumbo v10, "failed to read kernel wakelocks"

    invoke-static {v9, v10, v3}, Landroid/util/Slog;->wtf(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
