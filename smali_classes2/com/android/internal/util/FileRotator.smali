...
.method private getActiveName(J)Ljava/lang/String;
    ...
    .line 312
    .local v3, "oldestActiveName":Ljava/lang/String;
    ...
    invoke-direct {v1, v6}, Lcom/android/internal/util/FileRotator$FileInfo;-><init>(Ljava/lang/String;)V
    ...
    .line 318
    .local v0, "baseFiles":[Ljava/lang/String;
    if-nez v0, :cond_0

    .line 319
    iput-wide p1, v1, Lcom/android/internal/util/FileRotator$FileInfo;->startMillis:J

    .line 320
    iput-wide v10, v1, Lcom/android/internal/util/FileRotator$FileInfo;->endMillis:J

    .line 321
    invoke-virtual {v1}, Lcom/android/internal/util/FileRotator$FileInfo;->build()Ljava/lang/String;
    ...
    .end local v3    # "oldestActiveName":Ljava/lang/String;
    :goto_0
    if-ge v6, v7, :cond_3
    ...
    .line 328
    :cond_2
    invoke-virtual {v1}, Lcom/android/internal/util/FileRotator$FileInfo;->isActive()Z

    move-result v8

    if-eqz v8, :cond_1

    iget-wide v8, v1, Lcom/android/internal/util/FileRotator$FileInfo;->startMillis:J
    ...
    .line 331
    .local v3, "oldestActiveName":Ljava/lang/String;
    iget-wide v4, v1, Lcom/android/internal/util/FileRotator$FileInfo;->startMillis:J
...
.method public dumpAll(Ljava/io/OutputStream;)V
    ...
    .line 154
    const-string/jumbo v6, "FileRotator"

    const-string/jumbo v7, "FileRotator dumpAll mBasePath.list() is null."
