...
.method constructor <init>(Lorg/egret/plugin/mi/java/egretruntimelauncher/EgretRuntimeLibrary;Ljava/io/File;Ljava/io/File;)V
    ...
    .param p2, "val$cache"    # Ljava/io/File;
    .param p3, "val$target"    # Ljava/io/File;
...
.method public onError(Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "fail to unzip file: "
...
.method public onSuccess()V
    ...
    .prologue
    .line 108
    const-string/jumbo v0, "EgretRuntimeLibrary"

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v2, "Success to unzip file: "
    ...
    const-string/jumbo v2, "Fail to delete file: "
    ...
    invoke-static {v1}, Lorg/egret/plugin/mi/java/egretruntimelauncher/EgretRuntimeLibrary;->-get2(Lorg/egret/plugin/mi/java/egretruntimelauncher/EgretRuntimeLibrary;)Lorg/egret/plugin/mi/java/egretruntimelauncher/Library;
    ...
    const-string/jumbo v1, "target file md5 error"
