...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 55
    .local v49, "_result":Ljava/util/List;, "Ljava/util/List<Landroid/bluetooth/BluetoothDevice;>;"
    ...
    .end local v49    # "_result":Ljava/util/List;, "Ljava/util/List<Landroid/bluetooth/BluetoothDevice;>;"
    :sswitch_2
    const-string/jumbo v4, "android.bluetooth.IBluetoothGatt"
    ...
    check-cast v41, Landroid/bluetooth/le/AdvertiseData;
    ...
    check-cast v43, Landroid/bluetooth/le/AdvertiseData;
    ...
    check-cast v45, Landroid/bluetooth/le/AdvertiseSettings;
    ...
    .local v41, "_arg1":Landroid/bluetooth/le/AdvertiseData;
    goto :goto_5

    .line 130
    .end local v41    # "_arg1":Landroid/bluetooth/le/AdvertiseData;
    :cond_6
    const/16 v43, 0x0

    .local v43, "_arg2":Landroid/bluetooth/le/AdvertiseData;
    goto :goto_6

    .line 137
    .end local v43    # "_arg2":Landroid/bluetooth/le/AdvertiseData;
    :cond_7
    const/16 v45, 0x0

    .local v45, "_arg3":Landroid/bluetooth/le/AdvertiseSettings;
    goto :goto_7

    .line 145
    .end local v5    # "_arg0":I
    .end local v45    # "_arg3":Landroid/bluetooth/le/AdvertiseSettings;
    :sswitch_6
    const-string/jumbo v4, "android.bluetooth.IBluetoothGatt"
    ...
    check-cast v37, Landroid/os/ParcelUuid;
    ...
    .line 164
    .local v39, "_arg1":Landroid/bluetooth/IBluetoothGattCallback;
    move-object/from16 v0, p0
    ...
    .line 160
    .end local v39    # "_arg1":Landroid/bluetooth/IBluetoothGattCallback;
    :cond_8
    const/16 v37, 0x0

    .local v37, "_arg0":Landroid/os/ParcelUuid;
    goto :goto_8

    .line 170
    .end local v37    # "_arg0":Landroid/os/ParcelUuid;
    :sswitch_8
    const-string/jumbo v4, "android.bluetooth.IBluetoothGatt"
    ...
    .line 381
    .local v40, "_arg1":Landroid/bluetooth/IBluetoothGattServerCallback;
    move-object/from16 v0, p0
    ...
    .line 377
    .end local v40    # "_arg1":Landroid/bluetooth/IBluetoothGattServerCallback;
    :cond_c
    const/16 v37, 0x0

    .restart local v37    # "_arg0":Landroid/os/ParcelUuid;
    goto :goto_c
    ...
    check-cast v46, Landroid/os/ParcelUuid;
    ...
    .local v46, "_arg3":Landroid/os/ParcelUuid;
    goto :goto_10
    ...
    .end local v15    # "_arg2":I
    .end local v21    # "_arg1":I
    .end local v46    # "_arg3":Landroid/os/ParcelUuid;
    :sswitch_1d
    const-string/jumbo v4, "android.bluetooth.IBluetoothGatt"
    ...
    check-cast v42, Landroid/os/ParcelUuid;
    ...
    .local v42, "_arg1":Landroid/os/ParcelUuid;
    goto :goto_11

    .line 486
    .end local v5    # "_arg0":I
    .end local v42    # "_arg1":Landroid/os/ParcelUuid;
    :sswitch_1e
    const-string/jumbo v4, "android.bluetooth.IBluetoothGatt"
    ...
    .restart local v42    # "_arg1":Landroid/os/ParcelUuid;
    goto :goto_12
    ...
    .restart local v46    # "_arg3":Landroid/os/ParcelUuid;
    goto :goto_13
    ...
    .line 621
    .local v36, "_arg0":Landroid/bluetooth/IBluetoothGattCallback;
    move-object/from16 v0, p0

    move-object/from16 v1, v36

    invoke-virtual {v0, v1}, Landroid/bluetooth/IBluetoothGatt$Stub;->registerStatisticsClient(Landroid/bluetooth/IBluetoothGattCallback;)V
    ...
    .line 627
    .end local v36    # "_arg0":Landroid/bluetooth/IBluetoothGattCallback;
    :sswitch_28
    const-string/jumbo v4, "android.bluetooth.IBluetoothGatt"
    ...
    .line 630
    .restart local v36    # "_arg0":Landroid/bluetooth/IBluetoothGattCallback;
    move-object/from16 v0, p0

    move-object/from16 v1, v36

    invoke-virtual {v0, v1}, Landroid/bluetooth/IBluetoothGatt$Stub;->unregisterStatisticsClient(Landroid/bluetooth/IBluetoothGattCallback;)V
