...
.field static final TRANSACTION_addMediaPlayerAndUpdateRemoteController:I = 0x42

.field static final TRANSACTION_adjustLocalOrRemoteStreamVolume:I = 0x60
...
.field static final TRANSACTION_createAudioRecordForLoopback:I = 0x45
...
.field static final TRANSACTION_getNotificationUri:I = 0x40
...
.field static final TRANSACTION_removeMediaPlayerAndUpdateRemoteController:I = 0x43
...
.field static final TRANSACTION_setNowPrevHeadsetState:I = 0x44
...
.field static final TRANSACTION_updateRemoteControllerOnExistingMediaPlayers:I = 0x41
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 111
    .local v42, "_arg1":Landroid/os/IBinder;
    move-object/from16 v0, p0
    ...
    .end local v42    # "_arg1":Landroid/os/IBinder;
    :cond_1
    const/16 v37, 0x0
    ...
    .line 186
    .local v43, "_arg1":Ljava/lang/String;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .end local v7    # "_arg2":I
    .end local v37    # "_arg0":Z
    .end local v43    # "_arg1":Ljava/lang/String;
    :cond_4
    const/16 v37, 0x0
    ...
    .line 198
    .restart local v43    # "_arg1":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 278
    .restart local v42    # "_arg1":Landroid/os/IBinder;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readString()Ljava/lang/String;
    ...
    .local v45, "_arg2":Landroid/media/AudioAttributes;
    goto :goto_10

    .line 440
    .end local v26    # "_arg0":Landroid/media/IAudioFocusDispatcher;
    .end local v43    # "_arg1":Ljava/lang/String;
    .end local v45    # "_arg2":Landroid/media/AudioAttributes;
    :sswitch_25
    const-string/jumbo v4, "android.media.IAudioService"
    ...
    .line 660
    .local v39, "_arg1":Landroid/media/audiopolicy/IAudioPolicyCallback;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .line 655
    .end local v39    # "_arg1":Landroid/media/audiopolicy/IAudioPolicyCallback;
    ...
    .restart local v39    # "_arg1":Landroid/media/audiopolicy/IAudioPolicyCallback;
    :cond_1b
    const/16 v46, 0x0
    ...
    invoke-virtual {v0, v5, v6}, Landroid/media/IAudioService$Stub;->setNowPrevHeadsetState(II)V
    ...
    check-cast v35, Landroid/os/ParcelFileDescriptor;
    ...
    .line 784
    .local v51, "_result":Landroid/os/IBinder;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .end local v51    # "_result":Landroid/os/IBinder;
    :cond_1d
    const/16 v35, 0x0

    .local v35, "_arg0":Landroid/os/ParcelFileDescriptor;
    goto :goto_1d
    ...
    invoke-virtual/range {v4 .. v7}, Landroid/media/IAudioService$Stub;->adjustLocalOrRemoteStreamVolume(IILjava/lang/String;)V
