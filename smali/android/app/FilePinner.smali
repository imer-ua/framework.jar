...
.method static synthetic -wrap1(Ljava/util/ArrayList;Z)V
    .locals 0
    .param p0, "filesToPin"    # Ljava/util/ArrayList;
...
.method static handlePinAppFile(Landroid/app/Application;Landroid/app/LoadedApk;Landroid/content/res/Resources;)V
    ...
    .line 194
    .end local v2    # "goodToLock":Z
    .end local v4    # "pinTask":Landroid/app/FilePinner$PinTask;
    :cond_9
    return-void
.end method
...
.method private static recordHotPages(Ljava/util/ArrayList;Z)V
    ...
    .line 112
    .local v23, "pf":Ljava/lang/String;
    :try_start_0
    ...
    .line 117
    .local v24, "sb":Landroid/system/StructStat;
    ...
    .line 126
    aget-byte v2, v16, v22

    aget-byte v3, v27, v22

    and-int/2addr v2, v3

    int-to-byte v2, v2

    aput-byte v2, v16, v22
    ...
    .end local v16    # "currentCacheVec":[B
    .end local v24    # "sb":Landroid/system/StructStat;
    .end local v26    # "vecSize":I
    .end local v27    # "vector":[B
    :cond_1
    :goto_3
    ...
    .restart local v16    # "currentCacheVec":[B
    .restart local v24    # "sb":Landroid/system/StructStat;
    .restart local v26    # "vecSize":I
    .restart local v27    # "vector":[B
    :cond_2
    :try_start_2
    sget-object v2, Landroid/app/FilePinner;->mfileCaheVecs:Landroid/util/ArrayMap;
    ...
    .line 160
    .local v17, "e":Landroid/system/ErrnoException;
    :try_start_3
    ...
    invoke-virtual/range {v17 .. v17}, Landroid/system/ErrnoException;->getMessage()Ljava/lang/String;
    ...
    .line 166
    .local v18, "eClose":Landroid/system/ErrnoException;
    sget-object v2, Landroid/app/FilePinner;->TAG:Ljava/lang/String;
    ...
    .line 165
    .end local v17    # "e":Landroid/system/ErrnoException;
    .end local v18    # "eClose":Landroid/system/ErrnoException;
    .restart local v12    # "address":J
    .restart local v16    # "currentCacheVec":[B
    .restart local v24    # "sb":Landroid/system/StructStat;
    .restart local v26    # "vecSize":I
    ...
    .line 166
    .restart local v18    # "eClose":Landroid/system/ErrnoException;
    sget-object v2, Landroid/app/FilePinner;->TAG:Ljava/lang/String;
    ...
    .line 140
    .local v11, "cachedSize":I
    const/16 v20, 0x0

    .line 141
    .local v20, "lockCount":I
    :goto_4
    move/from16 v0, v21
    ...
    .line 161
    .end local v11    # "cachedSize":I
    .end local v12    # "address":J
    .end local v14    # "cachedPerc":D
    .end local v16    # "currentCacheVec":[B
    .end local v18    # "eClose":Landroid/system/ErrnoException;
    .end local v20    # "lockCount":I
    ...
    .end local v18    # "eClose":Landroid/system/ErrnoException;
    .end local v23    # "pf":Ljava/lang/String;
    :cond_8
    return-void
.end method
