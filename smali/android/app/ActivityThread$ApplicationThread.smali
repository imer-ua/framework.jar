...
.method private updatePendingConfiguration(Landroid/content/res/Configuration;)V
    ...
    invoke-static {v0}, Landroid/app/ActivityThread;->-get3(Landroid/app/ActivityThread;)Landroid/app/ResourcesManager;
...
.method public final bindApplication(Ljava/lang/String;Landroid/content/pm/ApplicationInfo;Ljava/util/List;Landroid/content/ComponentName;Landroid/app/ProfilerInfo;Landroid/os/Bundle;Landroid/app/IInstrumentationWatcher;Landroid/app/IUiAutomationConnection;IZZZZLandroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;Ljava/util/Map;Landroid/os/Bundle;)V
    ...
    invoke-static {v2}, Landroid/app/ActivityThread;->-set0(Z)Z
...
.method public dumpMessage()Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Landroid/os/Looper;->dumpAll(Ljava/lang/String;)Ljava/lang/String;
...
.method public notifyPackageForeground()V
    ...
    .prologue
    .line 1417
    invoke-static {}, Landroid/app/ActivityThread;->-get4()Z
    ...
    invoke-static {v0}, Landroid/app/ActivityThread;->-set0(Z)Z
...
.method public notifyProviderReady(JLandroid/app/IActivityManager$ContentProviderHolder;)V
    .locals 5
    .param p1, "threadId"    # J
    ...
    iget-object v2, v1, Landroid/app/ActivityThread;->mWaitThreadMap:Landroid/util/ArrayMap;
    ...
    iget-object v1, v1, Landroid/app/ActivityThread;->mWaitThreadMap:Landroid/util/ArrayMap;
    ...
    check-cast v0, Landroid/app/ActivityThread$ContentProviderCallbackImpl;

    .line 1405
    .local v0, "cpci":Landroid/app/ActivityThread$ContentProviderCallbackImpl;
    if-eqz v0, :cond_0
    ...
    .line 1407
    :try_start_1
    iput-object p3, v0, Landroid/app/ActivityThread$ContentProviderCallbackImpl;->mHolder:Landroid/app/IActivityManager$ContentProviderHolder;

    .line 1408
    const/4 v1, 0x1

    iput-boolean v1, v0, Landroid/app/ActivityThread$ContentProviderCallbackImpl;->removedByNotify:Z

    .line 1409
    const/4 v1, 0x0

    iput-boolean v1, v0, Landroid/app/ActivityThread$ContentProviderCallbackImpl;->waitForProvider:Z

    .line 1410
    invoke-virtual {v0}, Landroid/app/ActivityThread$ContentProviderCallbackImpl;->notifyAll()V
    :try_end_1
    ...
    .line 1403
    .end local v0    # "cpci":Landroid/app/ActivityThread$ContentProviderCallbackImpl;
    :catchall_1
    move-exception v1
